      ...
      <div class="card">
        ...
        <div class="card-body">
          <table id="table_id" class="table table-bordered table-striped">
            ...
            <tbody>
              @foreach($gasolinerias as $gasolineria)
              <tr>
                <td>{{$gasolineria->id}}</td>
                <td>{{$gasolineria->nombre}}</td>
                <td>
                  <center>
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu" role="menu">
                        <a class="dropdown-item" data-target="#modal-edit-{{$gasolineria->id}}" data-toggle="modal"><i class="fas fa-user-edit"></i> Editar</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" data-target="#modal-destroy-{{$gasolineria->id}}" data-toggle="modal"><i class="fas fa-user-times"></i> Eliminar</a>
                        <div class="dropdown-divider"></div>
                      </div>
                    </div>
                  </center>
              ...
              @include('admin.gasolinerias.destroy')
              @include('admin.gasolinerias.edit')
              @endforeach
            </tbody>
          </table>
        </div>
