<div class="modal fade" aria-hidden="true" id="modal-edit-{{$departamento->id}}" tabindex="-1" role="dialog" tabindex="-1"
  aria-hidden="true">
  <form method="POST" action="{{route('admin.departamentos.update',Crypt::encryptString($departamento->id))}}">
    @method('PUT')
    @csrf
