<div class="modal fade" aria-hidden="true" id="modal-create" tabindex="-1" role="dialog" tabindex="-1"
  aria-hidden="true">
  <form method="POST" action="{{route('admin.tipo_vehiculos.store')}}">
    @csrf
    <div class="modal-dialog" role="document">
      <div class="modal-content">
       <div class="modal-header">
        <h4 class="modal-title">Crear Tipo de Vehiculo</h4>
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-primary">Crear Tipo de Vehiculo</button>
        </div>
      </div>
    </div>
