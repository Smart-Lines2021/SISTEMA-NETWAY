    ...
    <div class="col-md-6">
        <div class="card card-info">
            ...
            <div class="card-body" style="display: block;">
                <form method="POST" action="{{route('admin.cuentas_bancarias_talleres.update',Crypt::encryptString($cuentaBancariaTaller->id))}}">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        ...
                        data-placeholder="Seleccione un Banco" style="width: 100%;" name="banco_id" required>
                         <option {{ old('banco_id') == $cuentaBancariaTaller->banco_id ? "selected" : "" }} value="{{$cuentaBancariaTaller->banco_id}}"> {{$cuentaBancariaTaller->banco->nombre}}</option>
                ...
                <div class="form-group">
                    ...
                    <option {{ old('taller_id') == $cuentaBancariaTaller->taller_id ? "selected" : "" }} value="{{$cuentaBancariaTaller->taller_id}}"> {{$cuentaBancariaTaller->taller->nombre}}</option>
            ...
            <div class="form-group">
              ...
              value="{{old('no_cuenta',$cuentaBancariaTaller->no_cuenta)}}">
          </div>
          <div class="form-group">
              ...
              value="{{old('clabe_interbancaria',$cuentaBancariaTaller->clabe_interbancaria)}}">
          </div>
