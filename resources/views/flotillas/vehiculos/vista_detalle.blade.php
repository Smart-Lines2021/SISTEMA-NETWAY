            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted"> {{$vehiculo->color}}</p>
            ...
            <div class="card">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Pólizas de seguro</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Mantenimientos Programados</a></li>
                        <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">Historial de Mantenimientos</a></li>
                    </ul>
                </div><!-- /.card-header -->
                <div class="card-body">
