<div class="modal fade" aria-hidden="true" id="modal-edit-{{$cliente->id}}" tabindex="-1" role="dialog" tabindex="-1"
  aria-hidden="true">
  <form method="POST" action="{{route('rh.clientes.update',Crypt::encryptString($cliente->id))}}">
    @method('PUT')
    @csrf
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-body">
       <div class="form-group">
          ...
          value="{{old('no_cliente', $cliente->no_cliente)}}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          value="{{old('iniciales', $cliente->iniciales)}}">
        </div>
        <div class="form-group">
