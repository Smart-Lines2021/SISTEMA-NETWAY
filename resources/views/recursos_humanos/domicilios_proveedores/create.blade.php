...
@section('title')
<h1 class="m-0 text-dark">Crear domicilio para {{$proveedor->nombre}}</h1>
@endsection
  ...
  <div class="col-md-6">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">Nuevo domicilio para el proveedor {{$proveedor->nombre}}</h3>
      ...
      <div class="card-body" style="display: block;">
        <form method="POST" action="{{route('rh.domicilios_proveedores.store')}}">
          @csrf
