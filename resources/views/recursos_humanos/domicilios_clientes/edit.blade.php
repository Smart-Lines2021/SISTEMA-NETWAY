...
@section('title')
<h1 class="m-0 text-dark">Editar domicilio para {{$cliente->nombre_empresa}}</h1>
@endsection
  ...
  <div class="col-md-6">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">Editar domicilio para el cliente {{$cliente->nombre_empresa}}</h3>
      ...
      <div class="card-body" style="display: block;">
        <form method="POST" action="{{route('rh.domicilios_clientes.update',Crypt::encryptString($domicilio->id))}}">
          @method('PUT')
          @csrf
