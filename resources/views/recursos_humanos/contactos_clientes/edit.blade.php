...
@section('title')
<h1 class="m-0 text-dark">Editar Contacto de {{$cliente->nombre_empresa}}</h1>
@endsection
  ...
  <div class="col-md-6">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">Editar contacto para el cliente {{$cliente->nombre_empresa}}</h3>
      ...
      <div class="card-body" style="display: block;">
        <form method="POST" action="{{route('rh.contactos_clientes.update',Crypt::encryptString($contacto->id))}}">
          @method('PUT')
          @csrf
          ...
          <div class="form-group">
            ...
            <input value="{{old('cumpleaños',$contacto->cumpleaños)}}" type="date" name="cumpleaños" class="form-control" required title="Seleccione la fecha de nacimiento de la persona a contactar">
          </div>
          <input type="hidden" id="cliente_id" name="cliente_id" value="{{$cliente->id}}" class="form-control">

          <button class="btn btn-info btn-block">Editar Contacto</button>
        </form>
