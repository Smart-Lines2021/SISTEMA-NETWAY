...
@section('title')
<h1 class="m-0 text-dark">Editar subempresa de {{$cliente->nombre_empresa}}</h1>
@endsection
  ...
  <div class="col-md-6">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">Editar subempresa del cliente {{$cliente->nombre_empresa}}</h3>
      ...
      <div class="card-body" style="display: block;">
        <form method="POST" action="{{route('rh.empresas_clientes.update',Crypt::encryptString($empresa->id))}}">
          @method('PUT')
          @csrf
          ...
          <div class="form-group">
            ...
            minlegth="4" maxlength="100"
            title="Solo se permiten letras y números. Tamaño mínimo: 4. Tamaño máximo: 100"
            value="{{old('domicilio_fiscal',$empresa->domicilio_fiscal)}}">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="horario" class="form-control" placeholder="Ingrese el horario de la subempresa del cliente" required pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ\s,.:0-9]{4,80}"
            minlegth="4" maxlength="80"
          ...
          <button class="btn btn-info btn-block">Editar Subempresa</button>
        </form>
